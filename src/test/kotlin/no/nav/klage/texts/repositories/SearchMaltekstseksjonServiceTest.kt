...
class SearchMaltekstseksjonServiceTest {
    ...
    fun `search maltekstseksjonVersion works`() {
        ...
        var foundMaltekstseksjonVersions =
            searchMaltekstseksjonService.searchMaltekstseksjoner(
        ...
        assertThat(
            foundMaltekstseksjonVersions,
        ).containsExactlyInAnyOrder(maltekstseksjon1, maltekstseksjon2, maltekstseksjon3, maltekstseksjon4)
        ...
        assertThat(
            foundMaltekstseksjonVersions,
        ).containsExactlyInAnyOrder(maltekstseksjon1, maltekstseksjon2, maltekstseksjon3, maltekstseksjon4, maltekstseksjon5)
        ...
        assertThat(
            foundMaltekstseksjonVersions,
        ).containsExactlyInAnyOrder(maltekstseksjon1, maltekstseksjon2, maltekstseksjon3, maltekstseksjon5)
    }
    ...
    fun `maltekstseksjonVersions with no specifications are considered a 'hit'`() {
        ...
        val foundMaltekstseksjonVersions =
            searchMaltekstseksjonService.searchMaltekstseksjoner(
                textIdList = listOf(),
